    ...
    public class CardController : Controller
    {
        ...
        public async Task<IActionResult> Checkout(OrderDto orderDto)
        {
            if (ModelState.IsValid)
            {
                ...
                //1)Kredi hartı numarası kontrolü
        ...
        private async void SaveOrder(OrderDto orderDto, string userId)
        {
            ...
            //Bunu geçici olarak yapıyoruz. Aslında buraya ödeme tamamlanmış halde geleceğiz ve buranın Completed olmasını sağlayacağız.
        ...
        private bool CardNumberControl(string cardNumber)
        {
           ...
           */
            ...
            {
                int nextOddNumber = Convert.ToInt32(cardNumber[i]);
                int nextOvenNumber= Convert.ToInt32(cardNumber[i+1]);
            ...
            bool isValidNuber=total%10==0 ? true : false;
            return isValidNuber;
        }
        [NonAction]
        private Payment PaymentProcess(OrderDto orderDto)
        {
            ...
            options.ApiKey = "sandbox-lHYs8phhES5YUMIKoYG2oJobI2o8NepV";
            options.SecretKey = "sandbox-N215C5aap3e9kG9LqyAs7tyAWLAfCIce";
            ...
            CreatePaymentRequest request = new CreatePaymentRequest
            {
                ...
                ShippingAddress=new Address
                {
                    ...
                    City="İstanbul",
                    Country="Türkiye",
                    Description="Balboros bulvarı yıldız iş Merkezi Kat:5"
                },
                BillingAddress = new Address
                {
                    ...
                    City = "İstanbul",
                    Country = "Türkiye",
                    Description = "Balboros bulvarı yıldız iş Merkezi Kat:3"
                }              
            };
            ...
            foreach (var item in orderDto.CardDto.CardItems)
            {
                ...
                basketItem.Category1 = "Genel";//Bu bize aslında cardDto içindeki productların category bilgilerinede doldurmamız gerektiğini hattırlatı.
        ...
        public async Task<IActionResult> GetOrders()
        {
            ...
            {
                orderListDtos = new OrderListDto()
                {
                    OrderId = order.Id,
