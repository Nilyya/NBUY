...
builder.Services.AddDbContext<IdentityContext>(options=>options.UseSqlite(builder.Configuration.GetConnectionString("SqliteConnection")));//Dosya adýný saklamak amaçla burayý deðiþtirdik appsetting.json içinde þifrelemeye aldýk
