        ...
        public void Configure(EntityTypeBuilder<Food> builder)
        {
            ...
            builder.HasData(
                new Food { Id = 1,IsHome=false, IsApproved = true, Name = "Kurban Eti Kavurması", 
                    Clue = "*Kavurma Kurban Etinin Neresinden Yapılır? Kavurma, koyun ve kuzu etinin but ve kol kısmından," +
                    " dana etinin ise sırt ve kol-kürek kısmından hazırlanır.\r\n*Kuyruk yağı yerine sıvı yağ kullanabilirsiniz." +
