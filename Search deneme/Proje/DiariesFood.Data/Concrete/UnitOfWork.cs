...
using DiariesFood.Data.Concrete.EfCore.Repository;
using System;
...
namespace DiariesFood.Data.Concrete
{
    public class UnitOfWork : IUnitOfWork
    {
        private readonly DiariesFoodContext _context;

        public UnitOfWork(DiariesFoodContext context)
        {
            _context = context;
        }
