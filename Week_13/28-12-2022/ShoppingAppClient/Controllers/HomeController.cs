...
namespace ShoppingAppClient.Controllers
{
    ...
    {     
        ...
        //{
        //    var products = new List<ProductViewModel>();
        //    using (var httpClient = new HttpClient("http://localhost:5200/api/products/"))
        //    {
        //        string apiRespose = await
        //            response.Content.ReadAsStringAsync();
        //        urunler = JsonConvert.DeserializeObject<List<ProductViewModel>>(apiRespose);
        //    }
        //}
