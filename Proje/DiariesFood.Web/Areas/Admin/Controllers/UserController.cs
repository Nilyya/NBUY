    ...
    public class UserController : Controller
    {
        ...
        public async Task<IActionResult> Create(UserAddDto userAddDto)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    TempData["Message"] = Jobs.PushMessage("Başarılı", $"{user.UserName} kullanıcısı başarıyla oluşturuldu", "success");
        ...
        public async Task<IActionResult> Edit(UserAddDto userUpdateDto)
        {
            if (ModelState.IsValid)
            {
                ...
                TempData["Message"] = Jobs.PushMessage("Başarılı", $"{user.UserName} başarıyla güncellendi", "success");
                return RedirectToAction("Index", "User");
            }
